...
public class DataSeed {
	...
	public void inicio() {
	    ...
	    cuponPromo.setCodigo("PR0M0 - VERANO25");
	    cuponPromo.setDescuento(20);
	    cuponPromo.setUsado(false);
	    cuponPromo.setFechaExpiracion(LocalDate.now().plusMonths(2));
	    ...
	    cuponRepository.save(cuponPromo);
	    cuponRepository.save(cuponUser);
